        ...
        return {
          ...
          tabs: [
            { 
              value: 'catalogue', 
              label: 'Catalogue', 
              content: <ProcedureCatalogTab searchTerm={searchTerm} setSearchTerm={setSearchTerm} onAddProcedure={handleAddClick} />
            },
            { 
              value: 'timeline', 
        ...
        return {
          ...
          tabs: [
            { 
              value: 'enrichment', 
              label: 'Alimentation', 
              content: <EnrichmentTab onAddProcedure={handleAddClick} />
            },
            { 
